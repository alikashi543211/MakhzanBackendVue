                  ...
                  <div class="navbar">
                    <div class="user-details me-auto">
                      ...
                      <div class="user-info float-start">
                        <router-link to="/profile"><span>Mike Litorus</span></router-link>
              ...
              <div class="modal-body">
                <div class="files-share-list">
                  <div class="files-cont">
                    ...
                    <div class="files-info">
                      <span class="file-name text-ellipsis">AHA Selfcare Mobile Application Test-Cases.xls</span>
                      <span class="file-author"><a href="javascript:void(0)">Bernardo Galaviz</a></span> <span class="file-date">May 31st at 6:53 PM</span>
                    </div>
                  </div>
                </div>
                <div class="form-group">

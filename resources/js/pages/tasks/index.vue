              ...
              <div class="chat-window">
                        ...
                        <div class="chats">
                          ...
                          <div class="task-header">
                            <div class="assignee-info">
                              <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#assignee">
                                <div class="avatar">
                          ...
                          <div class="task-information">
                            <span class="task-info-line"><a class="task-user" href="javascript:void(0)">Lesley Grauer</a> <span class="task-info-subject">created task</span></span>
                            <div class="task-time">Jan 20, 2019</div>
                          </div>
                          <div class="task-information">
                            <span class="task-info-line"><a class="task-user" href="javascript:void(0)">Lesley Grauer</a> <span class="task-info-subject">added to Hospital Administration</span></span>
                            <div class="task-time">Jan 20, 2019</div>
                          </div>
                          <div class="task-information">
                            <span class="task-info-line"><a class="task-user" href="javascript:void(0)">Lesley Grauer</a> <span class="task-info-subject">assigned to John Doe</span></span>
                            <div class="task-time">Jan 20, 2019</div>
                          </div>
                          <hr class="task-line">
                          <div class="task-information">
                            <span class="task-info-line"><a class="task-user" href="javascript:void(0)">John Doe</a> <span class="task-info-subject">changed the due date to Sep 28</span> </span>
                            <div class="task-time">9:09pm</div>
                          </div>
                          <div class="task-information">
                            <span class="task-info-line"><a class="task-user" href="javascript:void(0)">John Doe</a> <span class="task-info-subject">assigned to you</span></span>
                          ...
                          <div class="completed-task-msg"><span class="task-success"><a href="javascript:void(0)">John Doe</a> completed this task.</span> <span class="task-time">Today at 9:27am</span></div>
                          <div class="chat chat-left">
                            <div class="chat-avatar">
                              <router-link to="/profile" class="avatar">
                                <img alt="" src="../../../assets/img/profiles/avatar-02.jpg">
                ...
                <div class="chat-footer">
                  ...
                  <div class="project-members task-followers">
                    ...
                    <a class="avatar" href="javascript:void(0)" data-bs-toggle="tooltip" title="Jeffery Lalor">
                      <img alt="" src="../../../assets/img/profiles/avatar-16.jpg">
                    </a>
                    <a class="avatar" href="javascript:void(0)" data-bs-toggle="tooltip" title="Richard Miles">
